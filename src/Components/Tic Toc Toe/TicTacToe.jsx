...
const TicTacToe =() => {
    ...
    const won = (winner) => {
        setLock(true);
        if (winner === "x"){
            titleRef.current.innerHTML = `Congratulations <img src='${cross_icon}' > You are the winner!`;
        }
        else{
            titleRef.current.innerHTML = `Congratulations: <img src='${circle_icon}' > You are the winner!`;
        }
